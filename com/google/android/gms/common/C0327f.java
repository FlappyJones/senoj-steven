...
public final class C0327f {
    ...
    public static int m2439a(Context context) {
        PackageManager packageManager = context.getPackageManager();
        try {
            context.getResources().getString(C0337d.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
            Log.e("GooglePlayServicesUtil", "The Google Play services resources were not found. Check your project configuration to ensure that the resources are included.");
        }
        try {
            if (C0327f.m2447a(packageManager.getPackageInfo("com.android.vending", 64), f1532a) == null) {
                Log.w("GooglePlayServicesUtil", "Google Play Store signature invalid.");
                return 9;
            }
            try {
                PackageInfo packageInfo = packageManager.getPackageInfo("com.google.android.gms", 64);
                if (C0327f.m2447a(packageInfo, r4) == null) {
    ...
    public static Dialog m2440a(int i, Activity activity, int i2, OnCancelListener onCancelListener) {
        return C0327f.m2441a(i, activity, i2, onCancelListener, -1);
    }

    public static Dialog m2441a(int i, Activity activity, int i2, OnCancelListener onCancelListener, int i3) {
        Builder message = new Builder(activity).setMessage(C0327f.m2452b(activity, i, i3));
        if (onCancelListener != null) {
            message.setOnCancelListener(onCancelListener);
        }
        OnClickListener cpVar = new cp(activity, C0327f.m2442a(activity, i, i3), i2);
        CharSequence a = C0327f.m2443a((Context) activity, i);
        if (a != null) {
            message.setPositiveButton(a, cpVar);
        }
        switch (i) {
            case C0338e.MapAttrs_mapType /*0*/:
                return null;
            case C0338e.MapAttrs_cameraBearing /*1*/:
                return message.setTitle(C0337d.common_google_play_services_install_title).create();
            case C0338e.MapAttrs_cameraTargetLat /*2*/:
                return message.setTitle(C0337d.common_google_play_services_update_title).create();
            case C0338e.MapAttrs_cameraTargetLng /*3*/:
                return message.setTitle(C0337d.common_google_play_services_enable_title).create();
            case C0338e.MapAttrs_cameraTilt /*4*/:
            case C0338e.MapAttrs_uiCompass /*6*/:
                return message.setTitle(C0337d.common_google_play_services_unknown_issue).create();
            case C0338e.MapAttrs_cameraZoom /*5*/:
                Log.e("GooglePlayServicesUtil", "An invalid account was specified when connecting. Please provide a valid account.");
                return message.setTitle(C0337d.common_google_play_services_invalid_account_title).create();
            case C0338e.MapAttrs_uiRotateGestures /*7*/:
                Log.e("GooglePlayServicesUtil", "Network error occurred. Please retry request later.");
                return message.setTitle(C0337d.common_google_play_services_network_error_title).create();
            case C0338e.MapAttrs_uiScrollGestures /*8*/:
                Log.e("GooglePlayServicesUtil", "Internal error occurred. Please see logs for detailed information");
                return message.setTitle(C0337d.common_google_play_services_unknown_issue).create();
            case C0338e.MapAttrs_uiTiltGestures /*9*/:
                Log.e("GooglePlayServicesUtil", "Google Play services is invalid. Cannot recover.");
                return message.setTitle(C0337d.common_google_play_services_unsupported_title).create();
    ...
    public static Intent m2442a(Context context, int i, int i2) {
        switch (i) {
            case C0338e.MapAttrs_cameraBearing /*1*/:
            case C0338e.MapAttrs_cameraTargetLat /*2*/:
                return C0327f.m2445a(i2) ? C0327f.m2454c(context) ? da.m3646c("com.google.android.gms") : da.m3645b("com.google.android.apps.bazaar") : da.m3645b("com.google.android.gms");
            case C0338e.MapAttrs_cameraTargetLng /*3*/:
                return da.m3644a("com.google.android.gms");
            default:
                return null;
        }
    }

    public static String m2443a(Context context, int i) {
        Resources resources = context.getResources();
        switch (i) {
            case C0338e.MapAttrs_cameraBearing /*1*/:
                return resources.getString(C0337d.common_google_play_services_install_button);
            case C0338e.MapAttrs_cameraTargetLat /*2*/:
                return resources.getString(C0337d.common_google_play_services_update_button);
            case C0338e.MapAttrs_cameraTargetLng /*3*/:
                return resources.getString(C0337d.common_google_play_services_enable_button);
            default:
    ...
    public static boolean m2444a() {
        return f1537f ? f1538g : "user".equals(Build.TYPE);
    }

    static boolean m2445a(int i) {
        switch (C0327f.m2450b(i)) {
            case C0338e.MapAttrs_mapType /*0*/:
                return !C0327f.m2444a();
            case C0338e.MapAttrs_cameraBearing /*1*/:
                return true;
            case C0338e.MapAttrs_cameraTargetLat /*2*/:
                return false;
    ...
    public static boolean m2446a(Resources resources) {
        return (C0405p.m3729a() && ((resources.getConfiguration().screenLayout & 15) > 3)) || C0327f.m2453b(resources);
    }

    private static byte[] m2447a(PackageInfo packageInfo, byte[]... bArr) {
        try {
    ...
    private static byte[] m2448a(String str) {
        try {
    ...
    private static byte[][] m2449a(byte[][]... bArr) {
        int i = 0;
    ...
    private static int m2450b(int i) {
        return i == -1 ? 2 : i;
    }

    public static Context m2451b(Context context) {
        try {
    ...
    public static String m2452b(Context context, int i, int i2) {
        Resources resources = context.getResources();
        String string;
        switch (i) {
            case C0338e.MapAttrs_cameraBearing /*1*/:
                string = C0327f.m2446a(context.getResources()) ? resources.getString(C0337d.common_google_play_services_install_text_tablet) : resources.getString(C0337d.common_google_play_services_install_text_phone);
                return C0327f.m2445a(i2) ? string + " (via Bazaar)" : string;
            case C0338e.MapAttrs_cameraTargetLat /*2*/:
                string = resources.getString(C0337d.common_google_play_services_update_text);
                return C0327f.m2445a(i2) ? string + " (via Bazaar)" : string;
            case C0338e.MapAttrs_cameraTargetLng /*3*/:
                return resources.getString(C0337d.common_google_play_services_enable_text);
            case C0338e.MapAttrs_cameraZoom /*5*/:
                return resources.getString(C0337d.common_google_play_services_invalid_account_text);
            case C0338e.MapAttrs_uiRotateGestures /*7*/:
                return resources.getString(C0337d.common_google_play_services_network_error_text);
            case C0338e.MapAttrs_uiTiltGestures /*9*/:
                return resources.getString(C0337d.common_google_play_services_unsupported_text);
            default:
                return resources.getString(C0337d.common_google_play_services_unknown_issue);
        }
    }

    private static boolean m2453b(Resources resources) {
        Configuration configuration = resources.getConfiguration();
        return C0405p.m3732c() && (configuration.screenLayout & 15) <= 3 && configuration.smallestScreenWidthDp >= 600;
    }

    private static boolean m2454c(Context context) {
        if (f1537f) {
            return f1539h;
        }
        try {
            return C0327f.m2447a(context.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), f1536e) != null;
        } catch (NameNotFoundException e) {
            return false;
        }
    }
